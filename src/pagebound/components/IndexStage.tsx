...
export default function IndexStage() {
  ...
  return (
    <div className="h-full overflow-y-auto max-w-3xl mx-auto py-12 px-6">
      <p className="font-mono text-[11px] tracking-[0.2em] text-crimson uppercase mb-3">No. 05 — Back Matter</p>
      <h1 className="font-display italic text-3xl text-ink mb-2">Index</h1>
